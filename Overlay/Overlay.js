...
function modeswitch(){
    ...
    setTimeout(function(){bu1.style.backgroundColor='black';},475);
    setTimeout(function(){bu1.style.color='white';},475);
    setTimeout(function(){bu2.style.backgroundColor='black';},475);
    setTimeout(function(){bu2.style.color='white';},475);
    setTimeout(function(){bu3.style.backgroundColor='black';},475);
    setTimeout(function(){bu3.style.color='white';},475);
    setTimeout(function(){bu4.style.backgroundColor='black';},475);
    setTimeout(function(){bu4.style.color='white';},475);
    setTimeout(function(){bu5.style.backgroundColor='black';},475);
    setTimeout(function(){bu5.style.color='white';},475);
    setTimeout(function(){bu6.style.backgroundColor='black';},475);
    setTimeout(function(){bu6.style.color='white';},475);
    setTimeout(function(){bu7.style.backgroundColor='black';},475);
    setTimeout(function(){bu7.style.color='white';},475);
    setTimeout(function(){bu8.style.backgroundColor='black';},475);
    ...
    setTimeout(function(){bu1.style.backgroundColor='white';},475);
    setTimeout(function(){bu1.style.color='black';},475);
    setTimeout(function(){bu2.style.backgroundColor='white';},475);
    setTimeout(function(){bu2.style.color='black';},475);
    setTimeout(function(){bu3.style.backgroundColor='white';},475);
    setTimeout(function(){bu3.style.color='black';},475);
    setTimeout(function(){bu4.style.backgroundColor='white';},475);
    setTimeout(function(){bu4.style.color='black';},475);
    setTimeout(function(){bu5.style.backgroundColor='white';},475);
    setTimeout(function(){bu5.style.color='black';},475);
    setTimeout(function(){bu6.style.backgroundColor='white';},475);
    setTimeout(function(){bu6.style.color='black';},475);
    setTimeout(function(){bu7.style.backgroundColor='white';},475);
    setTimeout(function(){bu7.style.color='black';},475);
    setTimeout(function(){bu8.style.backgroundColor='white';},475);
